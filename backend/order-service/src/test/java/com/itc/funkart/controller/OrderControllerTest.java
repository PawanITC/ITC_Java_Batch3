...
class OrderControllerTest {
    ...
    @MockitoBean private JwtWebFilter jwtWebFilter;
    ...
    @Test
    @DisplayName("GET /api/v1/orders/{id} - returns order for authenticated user")
    void getOrder_success() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/orders/{id}", 101L))
    ...
    @Test
    @DisplayName("PATCH /api/v1/orders/{id}/cancel - delegates cancellation to service")
    void cancelOrder_success() throws Exception {
        mockMvc.perform(patch("/api/v1/orders/{id}/cancel", 101L))
                .andExpect(status().isOk())
    ...
    @Test
    @DisplayName("GET /api/v1/orders/history - returns full history list")
    ...
    @Test
    @DisplayName("GET /api/v1/orders/history - returns empty array when no orders")
