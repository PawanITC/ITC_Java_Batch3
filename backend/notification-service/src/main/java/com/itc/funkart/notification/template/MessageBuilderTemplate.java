package com.itc.funkart.notification.template;
...
public class MessageBuilderTemplate {
    public static String generateMessage(String orderId, OrderStatus status) {
        ...
        return switch (status) {
            ...
            case ORDER_UPDATED ->
                    "Great news! Your order #" + orderId + " has been updated successfully as per your request. please find the updated information" +
                            "attached below.";
            case ORDER_CANCELLED ->
                    "Sorry but you your order #" + orderId + " has been cancelled. This maybe because the order was cancelled by you " +
