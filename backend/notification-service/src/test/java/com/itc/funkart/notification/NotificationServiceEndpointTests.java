...
import com.itc.funkart.notification.controller.NotificationController;
...
public class NotificationServiceEndpointTests {
    ...
    @Test
        //if our request is valid then a 'successful' response should be returned
    ...
    @Test
        //if our request is invalid as both email/sms failed to send then an 'unsuccessful' response should be returned, (It's still an http 'ok' response!
