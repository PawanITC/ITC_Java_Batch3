...
import com.itc.funkart.notification.service.MockEmailSender;
...
public class mockEmailSenderTests {
    @Test
//the mock email sender should print out message to console when event parameter fields are valid
