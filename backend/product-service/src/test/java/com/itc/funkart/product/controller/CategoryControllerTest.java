...
import com.itc.funkart.product.controller.admin.AdminCategoryController;
...
class CategoryControllerTest {
    ...
    void deleteCategory_Success() throws Exception {
        mockMvc.perform(delete("/admin/categories/1").with(csrf()))
                .andExpect(status().isOk())
                // Match the actual controller output
                .andExpect(jsonPath("$.message").value("Category successfully removed"));
