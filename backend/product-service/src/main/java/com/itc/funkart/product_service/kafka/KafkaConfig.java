package com.itc.funkart.product_service.kafka;
...
public class KafkaConfig {
    ...
    public NewTopic productTopic() {
        return TopicBuilder.name(KafkaConstants.TOPIC_PRODUCTS).partitions(3).build();
    }

    @Bean
    public NewTopic orderTopic() {
        return TopicBuilder.name(KafkaConstants.TOPIC_ORDERS).partitions(3).build();
    }
}